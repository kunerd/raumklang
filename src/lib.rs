...
{
    let mut out_port = jack_client.register_port(config.out_port_name, jack::AudioOut::default())?;
...
pub fn play_white_noise(jack_client: jack::Client, config: &PlaySignalConfig) -> anyhow::Result<()> {
