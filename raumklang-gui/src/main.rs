...
use plotters::{
    coord::{
        ranged1d::{
            DefaultFormatting, DefaultValueFormatOption, NoDefaultFormatting, ValueFormatter,
        },
...
enum Message {
    ...
    New(TimeSeriesMessageNew),
    Back,
}

struct State {
    chart: ImpulseResponseChart,
    new_chart: TimeseriesChartNew,
...
impl Application for State {
    ...
    fn new(_flags: Self::Flags) -> (Self, Command<Self::Message>) {
        ...
        let new_chart = TimeseriesChartNew::new(
            WindowBuilder::new(Window::Hann, Window::Hann, 44100).build().into_iter(),
            TimeSeriesUnit::Samples
        );
    ...
    fn update(&mut self, message: Self::Message) -> Command<Self::Message> {
        match message {
            ...
            Message::New(msg) => self.new_chart.update_msg(msg),
        }
    ...
    fn view(&self) -> Element<'_, Self::Message> {
        ...
        widget::column!(btn, self.new_chart.view().map(Message::New)).into()
    }
