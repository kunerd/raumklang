use super::{measurement, ImpulseResponse, Samples, Window};
...
impl Computation {
    ...
    pub async fn run(self) -> (measurement::Id, FrequencyResponse) {
        ...
        (self.id, FrequencyResponse::new(frequency_response))
    }
}
